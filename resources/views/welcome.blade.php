...
<body>
            ...
            <div class="container">
                <div class="box">
                    <div class="badge flexcenter gap-8 mb-20">
                        <img src="{{ asset('asset/imgs/client-02.png') }}" alt="backgroundImg" />
    ...
    <div class="sidebar_sec">
        ...
        <div class="sidebar">
            ...
            <p>{{ env('APP_NAME') }} is a education website template. You can customize all.</p>
            <div class="contact">
                <div class="flexcenter gap-1">
                    <i class="fa-regular fa-envelope"></i>
        ...
        <div class="container">
            ...
            <div class="grid-2 gap-3">
                <div class="col">
                    <div class="grid">
                        <div class="item">
                            ...
                            <h2>Online Classes from {{ env('APP_NAME') }}</h2>
                ...
                <div class="col">
                    ...
                    <h2>Free Online Classes from {{ env('APP_NAME') }} School To Education</h2>
                    <p>Top instructors from around the world</p>
    ...
    <section class="courses bg-color">
        <div class="container">
            <div class="heading">
                <div class="badge">{{ env('APP_NAME') }} Course</div>
        ...
        <div class="container">
            <div class="flexBetween">
                <div class="left">
                    ...
                    <h1>{{ env('APP_NAME') }} Course Plan</h1>
                </div>
                <div class="right">
                    <div class="flexcenter gap-8">
    ...
    <section class="aboutus bg-color">
        <div class="container">
            <div class="heading">
                ...
                <h2>
                    People like {{ env('APP_NAME') }} education. <br />
            ...
            <div class="grid-2 gap-4">
                <div class="col">
                    ...
                    <h2>
                        {{ env('APP_NAME') }} The standard chunk of Lorem Ipsum used since the 1500s is
                        reproduced below for those interested. Sections Bonorum et Malorum
                        original.
                    </h2>
                    <p><span>{{ env('APP_NAME') }}</span> - COO, AMERIMAR ENTERPRISES, INC.</p>
                </div>
                <div class="col">
                    <div class="flex_imgs">
    ...
    <section class="our_post">
        <div class="container">
            <div class="heading">
                <div class="badge">{{ env('APP_NAME') }} Post</div>
                <h2>From Our Post.</h2>
                <p>
                    There are many variations of passages of the Ipsum available, but
                    the majority <br />
